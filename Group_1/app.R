...
ui <- dashboardPage(
  ...
  dashboardBody(tabItems(
    ...
    tabItem(
      ...
      a(href = "https://www.kaggle.com/ajaypalsinghlo/world-happiness-report-2021?select=world-happiness-report.csv", target =
          "_blank")
    )
  ))
...
server <- function(input, output, session) {
  ...
  output$plot2 = renderPlotly({
    q <-
      ...
      labs(title = "Relationship Between Healthy Life Expectancy and Happiness Score in Different Regions", x =
